...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT form_id, mentor_id, mentee_id, meeting_time, meeting_place, ending_time, pre_planned_purpose, topic_activities, accomplishment, goals_nextmeeting, mentees_next_meeting, mentors_next_meeting, time_next_meeting, place_next_meeting FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( form_id, mentor_id, mentee_id, meeting_time, meeting_place, ending_time, pre_planned_purpose, topic_activities, accomplishment, goals_nextmeeting, mentees_next_meeting, mentors_next_meeting, time_next_meeting, place_next_meeting ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET form_id = ?, mentor_id = ?, mentee_id = ?, meeting_time = ?, meeting_place = ?, ending_time = ?, pre_planned_purpose = ?, topic_activities = ?, accomplishment = ?, goals_nextmeeting = ?, mentees_next_meeting = ?, mentors_next_meeting = ?, time_next_meeting = ?, place_next_meeting = ? WHERE form_id = ?";
	...
	/** 
	 * Index of column ending_time
	 */
	protected static final int COLUMN_ENDING_TIME = 6;

	/** 
	 * Index of column pre_planned_purpose
	 */
	protected static final int COLUMN_PRE_PLANNED_PURPOSE = 7;

	/** 
	 * Index of column topic_activities
	 */
	protected static final int COLUMN_TOPIC_ACTIVITIES = 8;

	/** 
	 * Index of column accomplishment
	 */
	protected static final int COLUMN_ACCOMPLISHMENT = 9;

	/** 
	 * Index of column goals_nextmeeting
	 */
	protected static final int COLUMN_GOALS_NEXTMEETING = 10;

	/** 
	 * Index of column mentees_next_meeting
	 */
	protected static final int COLUMN_MENTEES_NEXT_MEETING = 11;

	/** 
	 * Index of column mentors_next_meeting
	 */
	protected static final int COLUMN_MENTORS_NEXT_MEETING = 12;

	/** 
	 * Index of column time_next_meeting
	 */
	protected static final int COLUMN_TIME_NEXT_MEETING = 13;

	/** 
	 * Index of column place_next_meeting
	 */
	protected static final int COLUMN_PLACE_NEXT_MEETING = 14;
	...
	public FormsPk insert(Forms dto) throws FormsDaoException
	{
		...
		try {
			...
			stmt.setTimestamp(index++, dto.getEndingTime()==null ? null : new java.sql.Timestamp( dto.getEndingTime().getTime() ) );
			stmt.setString( index++, dto.getPrePlannedPurpose() );
			stmt.setString( index++, dto.getTopicActivities() );
			stmt.setString( index++, dto.getAccomplishment() );
			stmt.setString( index++, dto.getGoalsNextmeeting() );
			stmt.setString( index++, dto.getMenteesNextMeeting() );
			stmt.setString( index++, dto.getMentorsNextMeeting() );
			stmt.setTimestamp(index++, dto.getTimeNextMeeting()==null ? null : new java.sql.Timestamp( dto.getTimeNextMeeting().getTime() ) );
			stmt.setString( index++, dto.getPlaceNextMeeting() );
	...
	protected void populateDto(Forms dto, ResultSet rs) throws SQLException
	{
		...
		dto.setEndingTime( rs.getTimestamp(COLUMN_ENDING_TIME ) );
		dto.setPrePlannedPurpose( rs.getString( COLUMN_PRE_PLANNED_PURPOSE ) );
		dto.setTopicActivities( rs.getString( COLUMN_TOPIC_ACTIVITIES ) );
		dto.setAccomplishment( rs.getString( COLUMN_ACCOMPLISHMENT ) );
		dto.setGoalsNextmeeting( rs.getString( COLUMN_GOALS_NEXTMEETING ) );
		dto.setMenteesNextMeeting( rs.getString( COLUMN_MENTEES_NEXT_MEETING ) );
		dto.setMentorsNextMeeting( rs.getString( COLUMN_MENTORS_NEXT_MEETING ) );
		dto.setTimeNextMeeting( rs.getTimestamp(COLUMN_TIME_NEXT_MEETING ) );
		dto.setPlaceNextMeeting( rs.getString( COLUMN_PLACE_NEXT_MEETING ) );
	}
